function generoPredito = classificarLivrosNaiveBayes(titulos, resumos, Generos, titulosTest, resumosTest)
    ...
    for g = 1:numGeneros
        ...
        indicesGenero = strcmp(Generos, genero); % Filtrar livros do gênero atual
